...
const SignInAndUp = () => {
    ...
    const { user, emailPasswordSignin, createAccount } = useContext(AuthContext)
                                        ...
                                        <div className="w-full md:w-3/5">
                                            ...
                                            <form onSubmit={handleSubmit(onSubmitSignIn)} >
                                                ...
                                                <div className="form-control">
                                                    ...
                                                    <p className='flex items-center gap-3' onClick={()=>setShowPassword(!showPassword)}>{showPassword?<><FaRegEyeSlash/><span>Show password</span></>:<><FaRegEye/><span>Hide password</span></> } </p>
